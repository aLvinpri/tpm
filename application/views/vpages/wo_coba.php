...
<form id="tgl_coba" name="tgl_coba" method="post" action="">
  <table width="1106" height="944" border="0" align="center">
    <tr>
      <th width="1100" height="940" scope="col"><table width="1091" border="0" align="center">
        <tr>
          <td colspan="7">		  </td>
        </tr>
        <tr>
          <td colspan="7"><div align="left"><strong>INPUT WO (WORK ORDER ) </strong></div></td>
        </tr>
        <tr>
          <td colspan="7">
...
?>
        ...
        <tr>
          <td><div align="left">Mesin</div></td>
         ...
         ?>
          ...
          <tr>
          <td width="146"><div align="left"><strong>No. Wo Produksi</strong></div></td>
          <td width="5"><div align="left"><strong>:</strong></div></td>
        ...
        <tr>
          ...
          <td colspan="5"><div align="left">
            ...
            &nbsp;&nbsp;&nbsp;format. 09:20:30 </div>            <div align="left"></div>
        ...
        <tr>
          <td><div align="left">Di Buat Oleh Produksi </div></td>
          <td><div align="left"></div></td>
          <td><div align="left">
        ...
        <tr>
          <td><div align="left">Jenis Pekerjaaan </div></td>
          <td>:</td>
          <td colspan="5">
            <div align="left">
        ...
        <tr>
          <td><div align="left">Status Mesin</div></td>
          <td><div align="left">:</div></td>
          <td><div align="left">
          ...
          <td>&nbsp;</td>
        <tr>
          <td><div align="left">Di Terima Oleh Maintenance </div></td>
          <td><div align="left">:</div></td>
          <td><div align="left">
      ...
      <!--EDIT 25-11-2019-->
        <tr>
          <td><div align="left">Pelaksana</div></td>
          <td><div align="left">:</div></td>
          <td><div align="left">
        ...
        <!--BATAS END-->
        <tr>
          <td><div align="left">Permasalahan Mesin </div></td>
          <td><div align="left">:</div></td>
        ...
        <tr>
          <td height="21"><div align="left">Penyebab Kerusakan </div></td>
          <td><div align="left">:</div></td>
        ...
        <tr>
          <td height="21"><div align="left">Tindakan</div></td>
          <td><div align="left">:</div></td>
          <td colspan="5" rowspan="2"><div align="left">
        ...
        <tr>
          <td><div align="left">Tanggal Di Kerjakan </div></td>
          <td>:</td>
          <td><div align="left">
            <input type="text" name="tgl_selesai22" id="tgl_selesai220" size="10"  value=""/>
            <a href="javascript:buka_tgl('kalender1.php?tgl_init='+document.tgl_coba.tgl_selesai22.value+'&amp;balik=tgl_coba.tgl_selesai22&amp;balik_format=yyy-mm-dd')"><img src="tgl.png" border="0" /></a></div></td>
        ...
        <tr>
          <td><div align="left">Di Serahkan Oleh (Bag. Maintenance </div></td>
          <td><div align="left">:</div></td>
          <td><div align="left">
        ...
        <tr>
          ...
          <a href="javascript:buka_tgl('kalender2.php?tgl_init='+document.tgl_coba.tgl_selesai224.value+'&amp;balik=tgl_coba.tgl_selesai224&amp;balik_format=yyy-mm-dd')"><img src="tgl.png" border="0" /></a></div></td>
          <td><div align="left">Jam</div></td>
          <td colspan="3"><div align="left">
...
TIDAK </td>
        ...
        <tr>
          <td><div align="left">Di Terima Oleh (Bag. Produksi) </div></td>
          <td><div align="left">:</div></td>
          <td colspan="5"><div align="left">
